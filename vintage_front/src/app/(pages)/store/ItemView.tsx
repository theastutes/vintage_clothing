...
const ItemView = async ({
  ...
  return (
    <div
      className="w-full max-w-full h-full items-center sm:justify-evenly justify-center overflow-x-hidden sm:flex sm:flex-row sm:gap-y-14 sm:gap-x-12 sm:flex-wrap sm:w-[85%] sm:mx-8
